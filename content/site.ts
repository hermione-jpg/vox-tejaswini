// ─────────────────────────────────────────────────────────────
// SITE COPY — EDITABLE
// Global text used on the home page, nav, and footer.
// ─────────────────────────────────────────────────────────────
...
export const homeCopy = {
  ...
  versionSection: {
    label: "Version .v1",
    text: "Version 1 is the first stable release of Vox. It establishes a shared foundation consisting of design tokens, interaction principles, conversation components, and documentation.",
  },
  ...
  conversationSection: {
    ...
    lines: [
      ...
      "Vox explores how design systems can evolve to support interactions where dialogue becomes the primary interface.",
    ],
  },
