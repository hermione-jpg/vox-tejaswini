...
import { TalkAboutThisPage } from "@/components/voice-ux/TalkAboutThisPage";
...
export default async function CaseStudyPage({
  ...
  const source = await getCaseStudyContent(slug);
    ...
    <main className="min-h-screen bg-white">
      <Container>
        <div className="max-w-3xl">
          ...
          {slug === "voice-for-learn" && (
            <TalkAboutThisPage slug={slug} />
          )}
